...
ft_ping reproduces the core behavior of inetutils 2, sending ICMP ECHO_REQUESTs and analyzing responses to monitor network latency and reliability. This project focuses on low-level network programming, precise timing, and robust packet parsing.
...
Smart Error Inspection: Parses deep ICMP error payloads (TTL Exceeded, Unreachable).

Precise Statistics: Live calculation of RTT (min/avg/max) and Mean Deviation (mdev).
